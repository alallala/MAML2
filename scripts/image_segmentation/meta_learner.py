...
class MetaLearner():
    ...
    def meta_update(cls,model_to_copy,args,alpha=0.01,grads=None): #grads are computed over trainable weights
        ...
        copied_model.get_layer("decoder_stage3b_bn").beta = model_to_copy.get_layer("decoder_stage3b_bn").beta
        
     
        #copied_model.get_layer("decoder_stage4a_conv").kernel = model_to_copy.get_layer("decoder_stage4a_conv").kernel 
        copied_model.get_layer("decoder_stage4a_transpose").kernel = model_to_copy.get_layer("decoder_stage4a_transpose").kernel 
        copied_model.get_layer("decoder_stage4a_bn").gamma = model_to_copy.get_layer("decoder_stage4a_bn").gamma 
        copied_model.get_layer("decoder_stage4a_bn").beta = model_to_copy.get_layer("decoder_stage4a_bn").beta 
        
        copied_model.get_layer("decoder_stage4b_conv").kernel = model_to_copy.get_layer("decoder_stage4b_conv").kernel 
        copied_model.get_layer("decoder_stage4b_bn").gamma = model_to_copy.get_layer("decoder_stage4b_bn").gamma 
        copied_model.get_layer("decoder_stage4b_bn").beta = model_to_copy.get_layer("decoder_stage4b_bn").beta
        ...
        copied_model.get_layer("decoder_stage0a_transpose").kernel = copied_model.get_layer("decoder_stage0a_transpose").kernel - alpha * grads[32]
        ...
        copied_model.get_layer("decoder_stage1a_transpose").kernel = copied_model.get_layer("decoder_stage1a_transpose").kernel - alpha * grads[38]
        ...
        copied_model.get_layer("decoder_stage2a_transpose").kernel = copied_model.get_layer("decoder_stage2a_transpose").kernel - alpha * grads[44]
        ...
        copied_model.get_layer("decoder_stage3a_transpose").kernel = copied_model.get_layer("decoder_stage3a_transpose").kernel - alpha * grads[50]
        ...
        copied_model.get_layer("decoder_stage4a_transpose").kernel = copied_model.get_layer("decoder_stage4a_transpose").kernel - alpha * grads[56]
